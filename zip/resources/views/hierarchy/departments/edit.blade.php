...
<head>
    ...
    <title>Edit {{ $displayName }} - GoalDocs</title>
    <meta name="description" content="Edit {{ strtolower($displayName) }}" />
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="py-3 mb-4">
                            <span class="text-muted fw-light">{{ $displayName }} Management /</span> Edit {{ $displayName }}
                        </h4>
                        
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card mb-4">
                                    <h5 class="card-header">Edit {{ $displayName }}</h5>
                                    <div class="card-body">
                                        <form action="{{ route('hierarchy.departments.update', $department) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                                          ...
                                                          placeholder="Describe the purpose of this {{ strtolower($displayName) }}">{{ old('description', $department->description) }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mt-4">
                                                <button type="submit" class="btn btn-primary me-2">
                                                    <i class="ti ti-check me-1"></i>Update {{ $displayName }}
                                                </button>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-3">
                                            <div class="avatar me-3" id="preview-avatar" style="background-color: {{ $department->color }};">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted" id="preview-count">{{ $department->activePositions->count() }} Positions</small>
                                            </div>
                                        </div>
                                        <p class="text-muted" id="preview-description">{{ $department->description ?: 'Description will appear here...' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
